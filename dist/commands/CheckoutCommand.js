...
function CheckoutCommand() {
    ...
    return (react_1["default"].createElement(GitBoundary_1["default"], { name: "git branch", state: gitBranches },
        react_1["default"].createElement(Column_1["default"], null,
            ...
            (featureBranches === null || featureBranches === void 0 ? void 0 : featureBranches.length) ? (react_1["default"].createElement(BranchSelect_1["default"], { branches: featureBranches, formatLabel: function (x) { return x.issueId + ": " + x.description + " (" + x.label + ")"; } })) : (react_1["default"].createElement(LogText_1["default"].Warn, null, "No feature branches found")))));
}
