...
function SelectIndicator(_a) {
    ...
    return (react_1["default"].createElement(ink_1.Box, { marginRight: 1 }, selected && focus ? react_1["default"].createElement(ink_1.Color, { cyan: true }, figures_1["default"].pointer) : ' '));
}
